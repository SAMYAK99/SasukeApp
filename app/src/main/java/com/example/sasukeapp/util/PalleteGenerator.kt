package com.example.sasukeapp.util
...
/*
* Used to extract the most frequent colors from image
* */
...
object PalleteGenerator {
    ...
    suspend fun convertImageUrlToBitmap(
        ...
        return if (imageResult is SuccessResult) {
            ...
            BitmapFactory.decodeResource(context.resources,R.drawable.explore)
        }
    }
